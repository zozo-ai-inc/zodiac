...
function setupPathSelection(): void {
	easyPathButton!.addEventListener(
		"click",
		() =>
			void (async () => {
	...
	powerPathButton!.addEventListener(
		"click",
		() =>
			void (async () => {
...
function setupThemeSelection(): void {
	...
	themeContinueButton!.addEventListener(
		"click",
		() =>
			void (async () => {
...
function setupAccountSelector(): void {
	continueWithAccountButton!.addEventListener(
		"click",
		() =>
			void (async () => {
	...
	useDifferentAccountButton!.addEventListener(
		"click",
		() =>
			void (async () => {
...
function setupAccountConfirmation(): void {
	confirmContinueButton!.addEventListener(
		"click",
		() =>
			void (async () => {
	...
	confirmDifferentAccountButton!.addEventListener(
		"click",
		() =>
			void (async () => {
				// Clear any pending credentials since user is switching accounts
...
function setupApiOrSubscriptionChoice(): void {
	chooseApiKeyButton!.addEventListener(
		"click",
		() =>
			void (async () => {
	...
	chooseSubscriptionButton!.addEventListener(
		"click",
		() =>
			void (async () => {
				onboardingService.setSetupOption("subscription");
...
function setupApiKeySetup(): void {
	...
	validateApiKeyButton!.addEventListener(
		"click",
		() =>
			void (async () => {
				await runValidation({
	...
	validateOpenRouterApiKeyButton!.addEventListener(
		"click",
		() =>
			void (async () => {
				await runValidation({
	...
	apiKeyNextButton!.addEventListener(
		"click",
		() =>
			void (async () => {
...
function setupRegistration(): void {
	...
	registerSkipButton!.addEventListener(
		"click",
		() =>
			void (async () => {
...
function setupSummary(): void {
	summaryFinishButton!.addEventListener(
		"click",
		() =>
			void (async () => {
...
function setupSubscriptionConfirmation(): void {
	subscriptionAutoLoginButton!.addEventListener(
		"click",
		() =>
			void (async () => {
...
function setupCloudSyncSetup(): void {
	...
	cloudSyncSkipButton!.addEventListener(
		"click",
		() =>
			void (async () => {
				if (onboardingCloudSyncMode === "setup") {
	...
	cloudSyncContinueButton!.addEventListener(
		"click",
		() =>
			void (async () => {
